...
export class AppComponent {
  ...
  layout: KtdGridLayout = [
    { id: '0', x: 0, y: 0, w: 2.95, h: 9 },
    { id: '1', x: 3, y: 0, w: 2.95, h: 4.1 },
    { id: '2', x: 0, y: 20, w: 2.95, h: 4.1, minW: 2, minH: 3 },
    { id: '3', x: 3, y: 3, w: 2.95, h: 4.1, minW: 2, minH: 3 }, //{ id: '3', x: 3, y: 3, w: 2.95, h: 4.1, minW: 2, maxW: 3, minH: 2, maxH: 5 },
  ];
